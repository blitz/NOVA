...
void Console_vga::init()
{
    ...
    Ptab::master()->map (VGACN_SADDR, 0xb9000, PAGE_SIZE,
...
unsigned Console_vga::init_spinner (unsigned cpu)
{
    if (!initialized)
        return 0;
    ...
    put (_num_row, 0, Cpu::secure ? COLOR_LIGHT_GREEN : COLOR_LIGHT_RED, (cpu & 0xf)["0123456789ABCDEF"]);
